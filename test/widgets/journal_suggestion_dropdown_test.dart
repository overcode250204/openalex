...
import 'package:openalex/widgets/journal/journal_suggestion_dropdown.dart';
...
void main() {
  ...
  group('JournalSuggestionDropdown', () {
    ...
    testWidgets('shows empty state when no suggestions and not loading',
      ...
      expect(find.text('No journals found.'), findsOneWidget);
    });
    ...
    testWidgets('shows suggestions list and taps correctly', (tester) async {
      ...
      expect(find.text('AAAS'), findsOneWidget);
